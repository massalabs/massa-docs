...
- **proof of stake**: A `type of consensus mechanism <https://en.wikipedia.org/wiki/Proof_of_stake>`_ in which power in the network is directly related to the amount of tokens one possesses.
