...
- `Linux binary <https://github.com/massalabs/massa/releases/download/TEST.18.0/massa_TEST.18.0_release_linux.tar.gz>`_
...
- set it as default: ``rustup default nightly-2022-12-24``
- check rust version: ``rustc --version``
...
- Open Windows Power Shell
  ...
  - Change default Rust to nightly: ``rustup default nightly-2022-12-24``
